...
for filename in os.listdir(input_folder):
    ...
    if is_image:
        try:
            ...
            if border_detected:
                print(f"{filename:<30} {'y':<6} {'y':<15} {border_height:<15} {'crop-output':<15}")
                ...
                print(f"{filename:<30} {'y':<6} {'n':<15} {'n/a':<15} {'crop-none':<15}")
...
'''
This version works great, but if it sees one row of black pixels it quantifies it as a border, crops it, and sends the files with the rest of them.'''