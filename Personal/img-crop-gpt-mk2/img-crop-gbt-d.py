...
'''
This version retains the error messages about too many values to unpack, but adds one extra pixel line of crop, eliminating
the remnant yellow of a previous version. '''